...
simulate()
{
  xsim top -key {Behavioral:sim_1:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0696.protoinst" -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/FPGA_EDA/Xilinx/2023_2/Vivado/2023.2/data/xsim"
  fi
