...
int read_file_from_sd()
{
	...
	// 读取整个文件到 `SourceBuffer` 数组，每次读取 `uint32_t` 数据
	// while (f_read(&file, SourceBuffer + count, MAX_DATA * sizeof(uint32_t), &br) == FR_OK && br > 0)
	// {
