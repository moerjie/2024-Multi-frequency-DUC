...
#define FILE_NAME3 "cuc_cookie.wav"
#define FIFO_DEV_ID XPAR_AXI_FIFO_0_DEVICE_ID
#define FIFO_DEV_ID2 XPAR_AXI_FIFO_1_DEVICE_ID
#define FIFO_DEV_ID3 XPAR_AXI_FIFO_2_DEVICE_ID
#define WORD_SIZE 4 /* Size of words in bytes */
#define MAX_PACKET_LEN 4
#define NO_OF_PACKETS 64
#define MAX_DATA_SIZE NO_OF_PACKETS *MAX_PACKET_LEN
#define MAX_DATA 23416 * 10 // 最多读取 1024 个数据点
