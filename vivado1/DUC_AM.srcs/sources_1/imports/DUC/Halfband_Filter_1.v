...
module Halfband_Filter_1
  ...
  wire signed [31:0] delayLineEnd6deadOut;  // sfix32_En30
  ...
  assign rdAddrEndNonZero = rdAddr4 != 3'b000;
  ...
  always @(rdAddr3) begin
    case ( rdAddr3)
      3'b000 :
        begin
          coeffTableOut3 = 32'sb01000000000000000000000000000000;
        end
      3'b001 :
        begin
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      ...
      3'b001 :
        begin
          coeffTableOut2 = 32'sb11111100110010000100100000110010;
        end
      3'b010 :
        begin
          coeffTableOut2 = 32'sb00000000000000000000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut2 = 32'sb00000110000010100000110100100111;
        end
      3'b100 :
        begin
          coeffTableOut2 = 32'sb00000000000000000000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut2 = 32'sb11110011110011001001101010110111;
        end
      3'b110 :
        begin
          coeffTableOut2 = 32'sb00000000000000000000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut2 = 32'sb00101000010000110100001010110001;
        end
      default :
        begin
          coeffTableOut2 = 32'sb00000000000000000000000000000000;
  ...
  Addressable_Delay_Line_block5 u_delayLine5 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
                                              .dataIn(delayLineEnd4),  // sfix32_En30
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      ...
      3'b001 :
        begin
          coeffTableOut1 = 32'sb11111111110110111000000101010011;
        end
      3'b010 :
        begin
          coeffTableOut1 = 32'sb00000000000000000000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut1 = 32'sb00000000010111010010010111011011;
        end
      3'b100 :
        begin
          coeffTableOut1 = 32'sb00000000000000000000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut1 = 32'sb11111111001011100011001111100001;
        end
      3'b110 :
        begin
          coeffTableOut1 = 32'sb00000000000000000000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut1 = 32'sb00000001101011010111101010111100;
        end
      default :
        begin
          coeffTableOut1 = 32'sb00000000000000000000000000000000;
  ...
  Addressable_Delay_Line_block5 u_delayLine6 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
                                              .dataIn(delayLineEnd5),  // sfix32_En30
                                              .validIn(delayLineShiftEn1_1),
                                              .wrAddr(wrAddr1),  // ufix3
                                              .rdAddr(rdAddReverse1),  // ufix3
                                              .delayLineEnd(delayLineEnd6deadOut),  // sfix32_En30
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      ...
      3'b101 :
        begin
          coeffTableOut0 = 32'sb11111111111111001011111000010100;
        end
      3'b110 :
        begin
          coeffTableOut0 = 32'sb00000000000000000000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut0 = 32'sb00000000000011000010100011100001;
        end
      default :
        begin
          coeffTableOut0 = 32'sb00000000000000000000000000000000;
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap0 (.clk(clk),
                                               ...
                                               .preAddIn(delayLineDataOut6),  // sfix32_En30
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap1 (.clk(clk),
                                               ...
                                               .preAddIn(delayLineDataOut5),  // sfix32_En30
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap2 (.clk(clk),
                                               ...
                                               .preAddIn(delayLineDataOut4),  // sfix32_En30
