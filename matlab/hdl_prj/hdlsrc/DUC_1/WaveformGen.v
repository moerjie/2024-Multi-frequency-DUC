// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\DUC_1\WaveformGen.v
...
// 
// Module: WaveformGen
// Source Path: DUC_1/AM_Modulator/NCO/WaveformGen
// Hierarchy Level: 2
// Model version: 3.18
// 
...
module WaveformGen
  ...
  wire signed [15:0] lutoutsin;  // sfix16_En2
  wire signed [15:0] ampOne;  // sfix16_En2
  wire signed [15:0] lutoutsin_ampOne;  // sfix16_En2
  wire signed [16:0] uminus_cast;  // sfix17_En2
  wire signed [16:0] uminus_cast_1;  // sfix17_En2
  wire signed [15:0] lutoutsin_ampOne_inv;  // sfix16_En2
  ...
  LookUpTableGen SineWave_inst_1 (.clk(clk),
                                  .reset(reset),
                                  .enb(enb),
                                  .lutaddr(lutaddrsin),  // ufix11
                                  .lutoutput(lutoutsin)  // sfix16_En2
                                  );

  assign ampOne = 16'sb0000000000000100;
