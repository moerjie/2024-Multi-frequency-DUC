// -------------------------------------------------------------
// 
// File Name: hdlsrc\DUC\FilterTapSystolicPreAddWvlIn.v
// Created: 2025-03-10 17:29:33
// 
...
// Source Path: DUC/DUC_module/Wave_Source/Discrete FIR Filter/Filter/subFilter/FilterTapSystolicPreAddWvlIn
// Hierarchy Level: 5
// Model version: 3.54
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAddWvlIn
  ...
  input   signed [47:0] addin;  // sfix48_En31
  input   dinRegVld;
  input   syncReset;
  output  signed [15:0] dinDly2;  // sfix16_En15
  output  signed [47:0] tapout;  // sfix48_En31
  ...
  reg signed [32:0] fTap_mult_reg_next;  // sfix33_En31
  ...
  reg signed [47:0] fTap_addout_reg_next;  // sfix48_En31
  ...
  reg signed [47:0] tapout_1;  // sfix48_En31
  reg signed [47:0] fTap_add_cast;  // sfix48_En31
  reg signed [16:0] fTap_add_cast_0;  // sfix17_En15
  reg signed [16:0] fTap_add_cast_1;  // sfix17_En15
