// -------------------------------------------------------------
// 
// File Name: hdlsrc\DUC\FirRdyLogic_block3.v
...
// Source Path: DUC/DUC_module/Wave_Source/Discrete FIR Filter/FirRdyLogic
// Hierarchy Level: 3
// Model version: 3.54
// 
// -------------------------------------------------------------
...
module FirRdyLogic_block3
  ...
  always @(coeff, dinSwitch, dinVldSwitch, firRdy_count, firRdy_readyReg, firRdy_state,
    ...
    if ((dinVldSwitch || (firRdy_count > 4'b0000)) || firRdy_out2_0) begin
      if (((firRdy_count == 4'b1101) || haltProcess) || syncReset) begin
