...
// 
// Module: subFilter
// Source Path: DUC/DUC_module/CIC_Comp Filter 1/Filter/subFilter
// Hierarchy Level: 3
// Model version: 3.21
// 
// -------------------------------------------------------------
...
module subFilter
  ...
  reg  [27:0] intdelay_reg;  // ufix1 [28]
  wire vldShift;
  wire vldOutTmp;
        ...
        if (enb) begin
          if (syncReset == 1'b1) begin
            ...
            if (dinRegVld) begin
              ...
              intdelay_reg[32'sd27:32'sd1] <= intdelay_reg[32'sd26:32'sd0];
            end
          end
        end
      end
  ...
  assign vldShift = intdelay_reg[27];
  ...
  assign dout_cast = tapout_23[30:15];
