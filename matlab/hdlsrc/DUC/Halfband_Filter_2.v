...
module Halfband_Filter_2
  ...
  wire signed [15:0] delayLineEnd6deadOut;  // sfix16_En15
  ...
  Addressable_Delay_Line_block7 u_delayLine3 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
  ...
  always @(rdAddr3) begin
    case ( rdAddr3)
      3'b000 :
        begin
          coeffTableOut3 = 16'sb0100000000000000;
        end
      3'b001 :
        begin
  ...
  Addressable_Delay_Line_block8 u_delayLine4 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      ...
      3'b001 :
        begin
          coeffTableOut2 = 16'sb1111110001001000;
        end
      3'b010 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut2 = 16'sb0000011001111111;
        end
      3'b100 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut2 = 16'sb1111001101111010;
        end
      3'b110 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut2 = 16'sb0010100001100001;
        end
      default :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
  ...
  Addressable_Delay_Line_block8 u_delayLine5 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      ...
      3'b001 :
        begin
          coeffTableOut1 = 16'sb1111111110110101;
        end
      3'b010 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut1 = 16'sb0000000010011101;
        end
      3'b100 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut1 = 16'sb1111111011010001;
        end
      3'b110 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut1 = 16'sb0000001000100011;
        end
      default :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
  ...
  Addressable_Delay_Line_block8 u_delayLine6 (.clk(clk),
                                              .rst_n(rst_n),
                                              .enb(enb),
                                              ...
                                              .delayLineEnd(delayLineEnd6deadOut),  // sfix16_En15
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      ...
      3'b101 :
        begin
          coeffTableOut0 = 16'sb1111111111110101;
        end
      3'b110 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut0 = 16'sb0000000000011111;
        end
      default :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
