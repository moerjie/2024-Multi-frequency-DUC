...
module AM_module
  ...
  wire signed [13:0] signal_downconvert_out1;  // sfix14_En11
  ...
  assign Constant7_out1 = 16'sb0100110011001101;
  always @(posedge clk)
  ...
  assign Product_out1 = Delay2_out1_1 * Delay4_out1_1;
  always @(posedge clk)
  ...
  assign signal_downconvert_out1 = Product1_out1_1[31:18];
  assign AM_OUT = signal_downconvert_out1;
