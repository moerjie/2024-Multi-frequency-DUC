...
// Source Path: DUC/DUC_module_with_ready/Halfband Filter 1
// Hierarchy Level: 1
// Model version: 3.89
// 
// Discrete FIR Filter
...
module Halfband_Filter_1
  ...
  reg signed [15:0] coeffTableOut0;  // sfix16_En14
  reg signed [15:0] coeffTableRegP0_1;  // sfix16_En14
  reg signed [15:0] coeffTableReg0_1;  // sfix16_En14
  reg [3:0] rdAddr1;  // ufix4
  wire rdAddrEndNonZero;
  wire rdAddrEndZero;
  reg  [3:0] finalSumValidPipe_reg;  // ufix1 [4]
  wire accumulate;
  wire signed [31:0] accDataOut;  // sfix32_En28
  wire signed [31:0] sumOut;  // sfix32_En28
  wire signed [31:0] accSwitchOut;  // sfix32_En28
  ...
  always @(dinVldSM, rdCountReverse_1, rdCount_1, sharingCount_1, wrCount_1) begin
    ...
    lastPhaseStrobe = sharingCount_1 == 4'b1011;
    if ((dinVldSM == 1'b1) || (sharingCount_1 > 4'b0000)) begin
      if (sharingCount_1 == 4'b1011) begin
    ...
    if ((sharingCount_1 > 4'b0000) || (dinVldSM == 1'b1)) begin
      ...
      else if (rdCountReverse_1 == 4'b1011) begin
        nextDelayLineRdAddrReverse = 4'b0000;
      end
      else begin
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      4'b0000 :
        begin
          coeffTableOut0 = 16'sb1111111111100110;
        end
      4'b0001 :
        begin
      ...
      4'b0010 :
        begin
          coeffTableOut0 = 16'sb0000000010000111;
        end
      4'b0011 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      4'b0100 :
        begin
          coeffTableOut0 = 16'sb1111111001000110;
        end
      4'b0101 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      4'b0110 :
        begin
          coeffTableOut0 = 16'sb0000010001111111;
        end
      4'b0111 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      4'b1000 :
        begin
          coeffTableOut0 = 16'sb1111010011111011;
        end
      4'b1001 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      4'b1010 :
        begin
          coeffTableOut0 = 16'sb0010011111010010;
        end
      4'b1011 :
        begin
  ...
  FilterTapSystolicPreAdd_block u_filterTap0 (.clk(clk),
                                              ...
                                              .preAddIn(delayLineDataOut1),  // sfix16_En14
                                              .coeff(coeffTableReg0_1),  // sfix16_En14
                                              .sumIn(accSwitchOut),  // sfix32_En28
                                              .sumOut(sumOut)  // sfix32_En28
                                              );

  assign converterOut = sumOut[28:13];
