...
module Halfband_Filter_1
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      ...
      3'b001 :
        begin
          coeffTableOut2 = 16'sb1111110011001000;
        end
      3'b010 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut2 = 16'sb0000011000001010;
        end
      3'b100 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut2 = 16'sb1111001111001101;
        end
      3'b110 :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut2 = 16'sb0010100001000011;
        end
      default :
        begin
          coeffTableOut2 = 16'sb0000000000000000;
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      ...
      3'b001 :
        begin
          coeffTableOut1 = 16'sb1111111111011100;
        end
      3'b010 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b011 :
        begin
          coeffTableOut1 = 16'sb0000000001011101;
        end
      3'b100 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut1 = 16'sb1111111100101110;
        end
      3'b110 :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut1 = 16'sb0000000110101101;
        end
      default :
        begin
          coeffTableOut1 = 16'sb0000000000000000;
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      ...
      3'b011 :
        begin
          coeffTableOut0 = 16'sb0000000000000001;
        end
      3'b100 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      3'b101 :
        begin
          coeffTableOut0 = 16'sb1111111111111101;
        end
      3'b110 :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
      ...
      3'b111 :
        begin
          coeffTableOut0 = 16'sb0000000000001100;
        end
      default :
        begin
          coeffTableOut0 = 16'sb0000000000000000;
