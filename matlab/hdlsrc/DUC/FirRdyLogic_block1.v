...
module FirRdyLogic_block1
  ...
  always @(coeff, dinSwitch, dinVldSwitch, firRdy_count, firRdy_readyReg, firRdy_state,
    ...
    if ((dinVldSwitch || (firRdy_count > 2'b00)) || firRdy_out2_0) begin
      if (((firRdy_count == 2'b11) || haltProcess) || syncReset) begin
        firRdy_count_next = 2'b00;
      end
      else begin
        firRdy_count_next = firRdy_count + 2'b01;
      end
    end
