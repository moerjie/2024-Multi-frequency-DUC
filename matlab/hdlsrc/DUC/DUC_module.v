...
module DUC_module
  ...
  input   clk_enable;
  output  ce_out;
  output  signed [15:0] DUC_Data_Out;  // sfix16_En14
  ...
  reg  Delay7_out1;
  reg signed [15:0] Delay6_out1;  // sfix16_En15
  ...
  wire signed [15:0] CIC_Delay_out1;  // sfix16_E23
  wire signed [15:0] Data_Type_Conversion_out1;  // sfix16_En15
  reg signed [15:0] Data_Type_Conversion_out1_1;  // sfix16_En15
  wire signed [31:0] Gain2_mul_temp;  // sfix32_En27
  wire signed [15:0] Gain2_out1;  // sfix16_En14
  reg signed [15:0] Gain2_out1_1;  // sfix16_En14

  // simulink仿真结果和vivado仿真结果不一样，预计是数制的问题
  // CIC Comp
  // Second HalfBand Filter or CIC Compensation Filter
  // First HalfBand Filter


  assign kconst = 16'sb0111000000000000;
  ...
  always @(posedge clk)
    begin : Delay2_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay2_out1 <= Halfband_Filter_1_out1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Delay3_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay3_out1 <= Halfband_Filter_1_out2;
        end
      end
    end
  ...
  assign count_value_2 = (need_to_wrap_1 == 1'b0 ? count_3 :
              count_from_3);
  assign count_4 = (Delay3_out1 == 1'b0 ? count_value_2 :
              count_reset_1);
  ...
  Halfband_Filter_2 u_Halfband_Filter_2 (.clk(clk),
                                         .rst_n(rst_n),
                                         .enb(enb),
                                         .dataIn(Delay2_out1),  // sfix16_En15
  ...
  always @(posedge clk)
    begin : Delay4_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay4_out1 <= Halfband_Filter_2_out1;
        end
      end
    end
  always @(posedge clk)
    begin : Delay5_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay5_out1 <= Halfband_Filter_2_out2;
        end
      end
    end
  CIC_Comp_Filter_1 u_CIC_Comp_Filter_1 (.clk(clk),
                                         .rst_n(rst_n),
                                         .enb(enb),
                                         .dataIn(Delay4_out1),  // sfix16_En15
                                         .validIn(Delay5_out1),
  ...
  always @(posedge clk)
    begin : Delay7_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay7_out1 <= CIC_Comp_Filter_2_out2;
        end
      end
    end
  always @(posedge clk)
    begin : Delay6_process
      if (rst_n == 1'b0) begin
        ...
        if (enb) begin
          Delay6_out1 <= CIC_Comp_Filter_2_out1;
        end
      end
    end
  assign Delay_ectrl = (Delay7_out1 == 1'b0 ? Delay_delOut :
              Delay6_out1);
  ...
  assign Delay_out1 = (Delay7_out1 == 1'b0 ? Delay_last_value :
              Delay_delOut);
  ...
  CIC_2 u_CIC_2 (.clk(clk),
                 ...
                 .CIC_2_out(CIC_Delay_out1)  // sfix16_E23
                 );
  assign Data_Type_Conversion_out1 = CIC_Delay_out1;
  always @(posedge clk)
    begin : HwModeRegister5_process
      if (rst_n == 1'b0) begin
        Data_Type_Conversion_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Gain2_mul_temp = kconst_1 * Data_Type_Conversion_out1_1;
  ...
  assign DUC_Data_Out = Gain2_out1_1;
