// -------------------------------------------------------------
// 
// File Name: hdlsrc\DUC_1\subFilter_block.v
...
// Source Path: DUC_1/DUC&AM/DUC_module/Halfband/Filter/subFilter
// Hierarchy Level: 4
// Model version: 3.5
// 
// -------------------------------------------------------------
...
module subFilter_block
  ...
  FilterTapSystolicWvldInC0 u_FilterTap_2 (.clk(clk),
                                           .enb(enb),
  ...
  FilterTapSystolicWvldInC0 u_FilterTap_4 (.clk(clk),
                                           .enb(enb),
  ...
  FilterTapSystolicWvldInC0 u_FilterTap_8 (.clk(clk),
                                           .enb(enb),
