// -------------------------------------------------------------
// 
// File Name: hdlsrc\DUC_1\FilterTapSystolicPreAddWvlIn_block1.v
...
// -------------------------------------------------------------
// 
// Module: FilterTapSystolicPreAddWvlIn_block1
// Source Path: DUC_1/DUC&AM/DUC_module/Lowpass/Filter/subFilter/FilterTapSystolicPreAddWvlIn
// Hierarchy Level: 5
// Model version: 3.5
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAddWvlIn_block1
  ...
  input   signed [43:0] addin;  // sfix44_En29
  input   dinRegVld;
  input   syncReset;
  output  signed [15:0] dinDly2;  // sfix16_En14
  output  signed [43:0] tapout;  // sfix44_En29
  ...
  reg signed [43:0] fTap_addout_reg_next;  // sfix44_En29
  ...
  reg signed [43:0] tapout_1;  // sfix44_En29
  ...
  reg signed [32:0] fTap_mul_temp;  // sfix33_En29
  reg signed [43:0] fTap_add_cast_1;  // sfix44_En29
...
endmodule  // FilterTapSystolicPreAddWvlIn_block1
