// -------------------------------------------------------------
// 
// File Name: D:\Desktop\Mul_Freq_DUC\2024-Multi-frequency-DUC\matlab\hdlsrc\DUC_1\WaveformGen_block.v
...
// Source Path: DUC_1/DUC_AM/NCO/WaveformGen
// Hierarchy Level: 2
// Model version: 3.16
// 
...
module WaveformGen_block
  ...
  input   reset;
  input   enb;
  input   [12:0] phaseIdx;  // ufix13_E11
  output  signed [31:0] sine;  // sfix32_En17


  reg [12:0] phaseIdxReg;  // ufix13_E11
  wire selsign;  // ufix1
  ...
  wire signed [31:0] lutoutsin;  // sfix32_En17
  wire signed [31:0] ampOne;  // sfix32_En17
  wire signed [31:0] lutoutsin_ampOne;  // sfix32_En17
  wire signed [32:0] uminus_cast;  // sfix33_En17
  wire signed [32:0] uminus_cast_1;  // sfix33_En17
  wire signed [31:0] lutoutsin_ampOne_inv;  // sfix32_En17
  ...
  LookUpTableGen_block SineWave_inst_1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .lutaddr(lutaddrsin),  // ufix11
                                        .lutoutput(lutoutsin)  // sfix32_En17
                                        );

  assign ampOne = 32'sb00000000000000100000000000000000;

  // Assign sine amplitude One
  assign lutoutsin_ampOne = (addrOverFsinreg == 1'b0 ? lutoutsin :
              ampOne);

  assign uminus_cast = {lutoutsin_ampOne[31], lutoutsin_ampOne};
  assign uminus_cast_1 =  - (uminus_cast);
  assign lutoutsin_ampOne_inv = uminus_cast_1[31:0];
