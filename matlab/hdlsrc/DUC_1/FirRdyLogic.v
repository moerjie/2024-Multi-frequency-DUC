// -------------------------------------------------------------
// 
// File Name: D:\Desktop\Mul_Freq_DUC\2024-Multi-frequency-DUC\matlab\hdlsrc\DUC_1\FirRdyLogic.v
...
// 
// Module: FirRdyLogic
// Source Path: DUC_1/DUC_AM/DUC_module/Lowpass/FirRdyLogic
// Hierarchy Level: 3
// Model version: 3.16
// 
// -------------------------------------------------------------
...
module FirRdyLogic
  ...
  input   reset;
  input   enb;
  input   signed [15:0] dinSwitch;  // sfix16_En14
  input   dinVldSwitch;
  input   signed [15:0] coeff;  // sfix16_En14
  input   haltProcess;
  output  signed [15:0] dinSM;  // sfix16_En14
  output  dinVldSM;
  ...
  reg signed [15:0] firRdy_xdin_next;  // sfix16_En14
  reg  firRdy_xdinVld_next;
  reg [2:0] firRdy_state_next;  // ufix3
  reg  firRdy_readyReg_next;
  reg [2:0] firRdy_count_next;  // ufix3
  reg signed [15:0] firRdy_xcoeffin_next;  // sfix16_En14
  reg  readySM;
  reg signed [15:0] dinSM_1;  // sfix16_En14
  reg  dinVldSM_1;
  reg signed [15:0] coeffS;  // sfix16_En14
  reg  firRdy_out2_0;
  ...
  always @(coeff, dinSwitch, dinVldSwitch, firRdy_count, firRdy_readyReg, firRdy_state,
    ...
    if ((dinVldSwitch || (firRdy_count > 3'b000)) || firRdy_out2_0) begin
      if (((firRdy_count == 3'b100) || haltProcess) || syncReset) begin
