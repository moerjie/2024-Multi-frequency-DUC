// -------------------------------------------------------------
// 
// File Name: D:\Desktop\Mul_Freq_DUC\2024-Multi-frequency-DUC\matlab\hdlsrc\DUC_1\FilterTapSystolicPreAdd.v
...
// Source Path: DUC_1/DUC_AM/DUC_module/Lowpass/FilterTapSystolicPreAdd
// Hierarchy Level: 3
// Model version: 3.16
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAdd
  ...
  wire signed [16:0] fTap_add_cast;  // sfix17_En14
  wire signed [16:0] fTap_add_cast_1;  // sfix17_En14
  wire signed [16:0] fTap_add_temp;  // sfix17_En14
  wire signed [32:0] fTap_mul_temp;  // sfix33_En29
  ...
  assign fTap_addout_reg_next = fTap_mul_temp + sumIn;
